...
def plot_graph(data):
    ...
    plt.plot(x, data['fill_rate'], label=r'$\rho_{fill}$')
...
if __name__ == "__main__":
    ...
    DIR = r'D:\Tiushkevich Andrei\Electrocoalescence\September_2024\alg_5_pure_oil\coel_1e_pure_q\coel_1'

    SAVE_DIR = r'\data\alg_pure_oil'
    FILE_NAME = r'coel_1'
